  ...
  <div class="flex items-end space-x-3">
    <div class="flex-1 relative">
      <textarea
        ...
        rows="1"
        maxlength="256"
        class="w-full resize-none border border-gray-200 bg-gray-50 px-4 py-3 pr-12 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 rounded-xl shadow-sm focus:shadow-md"
        {disabled}
      />
      <div class="absolute right-4 bottom-3 text-xs text-gray-400 font-medium">
        {message.length}/256
      </div>
    </div>
